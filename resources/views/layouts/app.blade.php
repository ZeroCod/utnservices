            ...
            <div class="container  " id="navbarColor01">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <form class="form-inline my-2 my-lg-0 col-md-5 col-md-offset-4" method="GET" action="{{ route('inicio') }}">
                      ...
                      <input class="form-control mr-sm-2" type="text" name="titulo" placeholder="Buscar servicios">
                      <button class="btn btn-success my-2 my-sm-0" type="submit">Buscar</button>
                    </form>
                    @else
                    <form class="form-inline my-2 my-lg-0 col-md-5 col-md-offset-4" method="GET" action="{{ route('home') }}">
